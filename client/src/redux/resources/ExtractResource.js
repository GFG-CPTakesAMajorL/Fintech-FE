...
class ExtractResource {
    ...
    extract(token, filename, bankname, height, width, isRotationRequired) {
        const body = {
            filename,
            bankname,
            height,
        ...
        return axios.post(this.host + "/extract/", body, config);
    }

    isProcessed(token, filename) {
        const body = {
            filename,
        }
        ...
        return axios.post(this.host + '/is_processed/', body, config)
    }
}

export default ExtractResource;